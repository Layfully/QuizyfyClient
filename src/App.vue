<template>
  <v-app>
    <DesktopNavbar :menuItems="menuItems" v-if="$vuetify.breakpoint.mdAndUp" />
    <v-main id="content">
    ...
    <Notification />
    <MobileNavbar :menuItems="menuItems" v-if="$vuetify.breakpoint.smAndDown" />
  </v-app>
</template>
...
extend("dimensions", {
  ...
  message:
    "Obraz musi mieć szerokość co najmniej {width}px i wysokość co najmniej {height}px.",
